...
// Funcion que valida seleccion de tickets 
let btnContinue = document.getElementById("btn-continue");
let radioButtons = document.querySelectorAll('input[name="ticket"]');
...
// Boton que redirige a la pagina de Confirmacion
...
continueBtn.addEventListener("click", continuePurchase)
